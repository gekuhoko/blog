    ...
    <div class="container">
        <div style="float: right; padding-top:4px; margin-right: -12px;">
            @if(strpos(Request::path(), 'profile') === false)
                <a class="btn" href="/profile" style="background-color: #EB5634; color: #ffffff; font-weight:900; padding-left: 14px; padding-right: 15px;">Profile</a>
            @else
        ...
        <div class="navbar-header page-scroll">
            @if(strpos(Request::path(), 'blog') !== false)
                ...
                <a class="navbar-brand page-scroll" href="/author" style="font-weight:200; font-size:16px;">{{config('owner.name')}}</a>
